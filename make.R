...
paste("Data rast done in", round(duration_rast, 3), "min")
...
paste("Dashboard done in", round(duration_qmd, 3), "min")
...
paste("Shiny app data preparation done in", round(duration_shiny, 3), "min")
